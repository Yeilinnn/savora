...
public class PaqueteSorpresa {
    ...
    @Column(name = "precio_con_descuento", nullable = false)
    private BigDecimal precioConDescuento;

    @Column(name = "hora_limite_recogida", nullable = false)
    private OffsetDateTime horaLimiteRecogida;
    ...
    public OffsetDateTime getHoraLimiteRecogida() {
        return horaLimiteRecogida;
    }

    public void setHoraLimiteRecogida(OffsetDateTime horaLimiteRecogida) {
        this.horaLimiteRecogida = horaLimiteRecogida;
    }
